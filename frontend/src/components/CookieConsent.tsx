        ...
        return (
            <div className="fixed inset-0 bg-background flex flex-col items-center justify-center z-[100] p-4 text-center">
                ...
                <p className="mb-6 max-w-md text-muted-foreground">
                    This application requires essential cookies to function correctly (such as keeping you logged in). You can choose to allow cookieless analytics tracking or proceed with essential cookies only.
                </p>
    ...
    return (
        <div className="fixed bottom-4 left-1/2 -translate-x-1/2 bg-card text-card-foreground p-4 rounded-lg shadow-lg border border-border max-w-md w-full flex flex-col items-center z-50">
            <p className="mb-4 text-sm text-center text-muted-foreground">
                We use cookies to improve your experience and cookieless tracking to analyze site traffic. We do not sell your personal information. By clicking "Accept All", you consent to our use of tracking and cookies.
            </p>
