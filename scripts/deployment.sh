...
if [ -f "$ENV_FILE" ]; then
    ...
    if [[ "$use_existing" =~ ^[Yy]$ ]]; then
        ...
        ask_var "SMTP_HOST" "Enter SMTP_HOST (e.g., smtp.gmail.com):" "false"
        ask_var "SMTP_USER" "Enter SMTP_USER (Email):" "false"
        ask_var "SMTP_PASS" "Enter SMTP_PASS (Email Password):" "true"
        ask_var "SMTP_FROM" "Enter SMTP_FROM (Optional, sending alias):" "false"
        ask_var "CONTACT_SMTP_HOST" "Enter CONTACT_SMTP_HOST (e.g., smtp.gmail.com):" "false"
        ask_var "CONTACT_SMTP_USER" "Enter CONTACT_SMTP_USER (Email):" "false"
        ask_var "CONTACT_SMTP_PASS" "Enter CONTACT_SMTP_PASS (Email Password):" "true"
        ask_var "CONTACT_SMTP_FROM" "Enter CONTACT_SMTP_FROM (Optional, sending alias):" "false"
